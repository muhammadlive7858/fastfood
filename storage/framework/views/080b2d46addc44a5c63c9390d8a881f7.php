        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-4 label">Kompaniya nomi</div>
                <div class="col-lg-9 col-md-8"><?php echo e($user->company); ?></div>
              </div>
              ...
              <!-- <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?php echo e($user->email); ?>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <form action="<?php echo e(route('user.update',$user->id)); ?>" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <textarea name="description" class="form-control" id="about" style="height: 100px"><?php echo e($user->description); ?>.</textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="company" type="text" class="form-control" id="company" value="<?php echo e($user->company); ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="address" type="text" class="form-control" id="Address" value="<?php echo e($user->address); ?>">
                  </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OSPanel\domains\fastfood2.uz\fastfood\resources\views/user/index.blade.php ENDPATH**/ ?>